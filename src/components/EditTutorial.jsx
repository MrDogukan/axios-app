...
const EditTutorial = ({ updateTutorials, editItem }) => {
  ...
  //? componenetDidUpdate
  //newTitle veya description her değiştiğinde
  //local title ve desc stateleri güncellenir
  useEffect(() => {
    setTitle(newTitle);
    setDesc(description);
